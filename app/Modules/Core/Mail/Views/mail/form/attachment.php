<div class="border rounded mt-2 mb-4 p-2 bg-light">
    <?php if(!empty($attachs_doc)):?>
        <div class="mb-2">
            <?php foreach($attachs_doc as $doc):?>
                <div class="form-check row">
                    <div class="col-10">
                        <input type="checkbox" class="form-check-input" name="ids_attach_selected[]" 
            ...
            <?php foreach($attachs_img as $img):?>
                <div class="col-lg-2 col-md-3 col-sm-2 pr-2">
                    <div class="card h-100 pt-2 px-2 pb-0">
                        <input type="checkbox" name="ids_attach_selected[]" value="<?php echo $img->id_attach;?>"/>
