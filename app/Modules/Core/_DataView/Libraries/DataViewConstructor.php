...
class DataViewConstructor
{
    ...
    public function getFieldsGestion($type)
    {
        ...
        return $this->dataViewConstructorModel->getFieldsGestion($type);
   ...
   public function getListAddField($type=NULL,$entity=NULL)
    ...
    public function getElementForm($index,$fields=array(),$value=NULL,$num_container=NULL,$is_ligne=FALSE,$is_dselect=TRUE,$is_ajax=FALSE)
    {
        ...
        switch($this->getType($fields)){
            case "no_modif_date":
                return view($this->path."form-no-modif-date", 
                [   "value"=>$value,
                    "index"=>trim($index),
                    "label"=>$label,
                ...
                case "no_modif":
                    return view($this->path."form-no-modif", 
                    [   "value"=>$value,
                        "index"=>trim($index),
                        "label"=>$label,
           ...
           case "textarea":     return view($this->path."form-textarea", 
                                            [   "value"=>$value,
                                                "index"=>trim($index),
                                                "label"=>$label,
           ...
           case "select":      return view($this->path."form-selection", 
                                            [   "value"=>$value,
                                                "index"=>trim($index),
            ...
            case "radio":      return view($this->path."form-radio", 
                                            [   "value"=>$value,
                                                "index"=>trim($index),
            ...
            case "check":      return view($this->path."form-check", 
                                            [   "value"=>$value,
                                                "index"=>trim($index),
                                                "checks"=>$this->dataViewConstructorModel->getCheck($fields,$value),
                                                "num_container"=>$num_container,
            ...
            case "boolean": return view($this->path . "form-boolean", [
                "value"=>$value,
                "index"=>$index,
            ]); 

            case "birthday":                                
            case "date":        return view($this->path."form-datepicker", 
                                            [   "value"=>$value,
                                                "index"=>trim($index),
                                                "label"=>$label,
                                                "num_container"=>$num_container,
            ...
            case "date_with_heure":        return view($this->path."form-date-with-heure", 
                                                [   "value"=>$value,
                                                    "index"=>trim($index),
                                                    "label"=>$label,
                                                    "num_container"=>$num_container,
            ...
            break;
            default:             return view($this->path."form-input-text", 
                                            [   "value"=>$value,
                                                "index"=>trim($index),
                                                "label"=>$label,
                                                "num_container"=>$num_container,
