...
class TablesMapping_230709 extends BaseMigration
{
    ...
    public function up()
    {
        ...
        $this->TableBienGeocode();
        $this->TableComponentBien();
        $this->TableComponentDemande();
        debug('---------- END ' . basename(__FILE__) . ' ----------');
    }

    private function TableComponentDemande()
    {
...
// debugd(database_encode($this->t_component_bien, $data));
    ...
    private function TableBienGeocode()
    {
    ...
    private function TableComponentBien()
    {
