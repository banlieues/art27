    ...
    <div class="col-md-9">
        <form action="<?php echo base_url('cropper/settings'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="float-end">
                ...
                <a class="btn btn-danger btn-sm" href="<?php echo base_url('cropper/settings'); ?>">
            ...
            <div class="card flex-fill mb-4">
                ...
                <h5 class="card-header">
                    ...
                    <?php echo lang('Cropper.settings_of'); ?> : <?php echo lang('Cropper.edit'); ?>
                </h5>
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select cropper" aria-label="Select a cropper" name="selectCropper">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-check form-check-inline mt-2">
                                        <input class="form-check-input" type="radio" name="viewMode" id="viewMode0" value="0" <?php echo $cropper_settings['cropper_viewMode'] == '0' ? 'checked' : null; ?>>
                                        <label class="form-check-label" for="viewMode0">0</label>
                                    </div>
                                    <div class="form-check form-check-inline mt-2">
                                        <input class="form-check-input" type="radio" name="viewMode" id="viewMode1" value="1" <?php echo $cropper_settings['cropper_viewMode'] == '1' ? 'checked' : null; ?>>
                                        <label class="form-check-label" for="viewMode1">1</label>
                                    </div>
                                    <div class="form-check form-check-inline mt-2">
                                        <input class="form-check-input" type="radio" name="viewMode" id="viewMode2" value="2" <?php echo $cropper_settings['cropper_viewMode'] == '2' ? 'checked' : null; ?>>
                                        <label class="form-check-label" for="viewMode2">2</label>
                                    </div>
                                    <div class="form-check form-check-inline mt-2">
                                        <input class="form-check-input" type="radio" name="viewMode" id="viewMode3" value="3" <?php echo $cropper_settings['cropper_viewMode'] == '3' ? 'checked' : null; ?>>
                        ...
                        <li class="list-group-item param">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-check form-check-inline mt-2">
                                        <input class="form-check-input" type="radio" name="dragMode" id="dragModecrop" value="crop" <?php echo $cropper_settings['cropper_dragMode'] == 'crop' ? 'checked' : null; ?>>
                                        <label class="form-check-label" for="dragModecrop"><?php echo lang('Cropper.crop'); ?></label>
                                    </div>
                                    <div class="form-check form-check-inline mt-2">
                                        <input class="form-check-input" type="radio" name="dragMode" id="dragModemove" value="move" <?php echo $cropper_settings['cropper_dragMode'] == 'move' ? 'checked' : null; ?>>
                                        <label class="form-check-label" for="dragModemove"><?php echo lang('Cropper.move'); ?></label>
                                    </div>
                                    <div class="form-check form-check-inline mt-2">
                                        <input class="form-check-input" type="radio" name="dragMode" id="dragModenone" value="none" <?php echo $cropper_settings['cropper_dragMode'] == 'none' ? 'checked' : null; ?>>
                        ...
                        <li class="list-group-item param">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-check form-check-inline mt-2">
                                        <input class="form-check-input aspectRatio" type="radio" name="aspectRatio" id="aspectRatio11" value="11" <?php echo $cropper_settings['cropper_aspectRatio'] == '11' ? 'checked' : null; ?>>
                                        <label class="form-check-label" for="aspectRatio11">1/1</label>
                                    </div>
                                    <div class="form-check form-check-inline mt-2">
                                        <input class="form-check-input aspectRatio" type="radio" name="aspectRatio" id="aspectRatio43" value="43" <?php echo $cropper_settings['cropper_aspectRatio'] == '43' ? 'checked' : null; ?>>
                                        <label class="form-check-label" for="aspectRatio43">4/3</label>
                                    </div>
                                    <div class="form-check form-check-inline mt-2">
                                        <input class="form-check-input aspectRatio" type="radio" name="aspectRatio" id="aspectRatio169" value="169" <?php echo $cropper_settings['cropper_aspectRatio'] == '169' ? 'checked' : null; ?>>
                        ...
                        <li class="list-group-item param">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" step="0.1" class="form-control width" name="minCropBoxWidth" id="minCropBoxWidth" 
                                        value="<?php echo $cropper_settings['cropper_minCropBoxWidth']; ?>" placeholder="<?php echo $cropper_settings['cropper_minCropBoxWidth']; ?>">
                                </div>
                            </div>
                        </li>
                        <li class="list-group-item param">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" step="0.1" class="form-control height" name="minCropBoxHeight" id="minCropBoxHeight" 
                                        value="<?php echo $cropper_settings['cropper_minCropBoxHeight']; ?>" placeholder="<?php echo $cropper_settings['cropper_minCropBoxWidth']; ?>">
                                </div>
                            </div>
                        </li>
                    </ul>
