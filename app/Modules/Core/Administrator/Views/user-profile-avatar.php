...
<div class="modal fade" id="modalAvatar" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        let view_mode = parseInt(<?php echo $cropper_view_mode; ?>); // default is 1
        let drag_mode = (<?php echo $cropper_drag_mode; ?>).toString(); // default is crop
        let aspect_ratio = parseInt(<?php echo $cropper_aspect_ratio; ?>); // default is 1
        let min_cropbox_width = parseFloat(<?php echo $cropper_min_cropbox_width; ?>); // default is 256
        let min_cropbox_height = parseFloat(<?php echo $cropper_min_cropbox_height; ?>); // default is 256
