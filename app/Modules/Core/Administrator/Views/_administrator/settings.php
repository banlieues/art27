...
<div class="row">
    ...
    <div class="col-md-9">
        <div class="float-end">
            ...
            <a class="btn btn-success btn-sm" href="<?php echo base_url('administrator/settings/?action=save'); ?>">
                <i class="<?php echo icon('save'); ?>"></i> <?php echo lang('Buttons.save'); ?>
            </a>
            <a class="btn btn-danger btn-sm" href="<?php echo base_url('administrator/settings/?action=cancel'); ?>">
        ...
        <div class="card flex-fill mb-4">
            <h5 class="card-header">
                ...
                <?php echo lang('Administrator.administrator_settings'); ?> : <?php echo lang('Administrator.edit'); ?>
            </h5>
