...
class dataViewConstructorModel extends Model
{
    ...
    public function getListField($field)
    {
        ...
        $builder->select("*, $field->key_list as id, CONCAT_WS(' ', $field->label_list) as label ");
    ...
    {
        $builder=$this->db->table($field["table_list"]);
        $builder->select($field["key_list"]." as key, CONCAT_WS(' ', " . $field['label_list'] . ") as label");
    ...
    */
    ...
    public function set_log_fiche($entity,$newValues,$id_primary_name,$id_primary_value,$table,$type)
    {
        ...
        $builder->where(["type"=>$type]);
        $indexes_possible_all=$builder->get()->getResult();
        ...
        foreach($indexes_possible_all as $possible)
        {
            $indexes_possible=explode(",",$possible->fields);
