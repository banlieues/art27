...
<script type="text/javascript">
	...
	{
		//setTimeout(function(){refresh_mails_notraites();refresh_mails_nolus(1);refresh_mails_nolus(0);refresh_message_nonlus();refresh_message_nolus_affiche();},1000);
	    ...
	    ({	
		    ...
		    success: function(html){ 
		    	if(count==1){
					...
					$('.indicator_mail_non_lu').html(html);
					
		    	}else{
		    		$('.indicator_mail_non_lu').closest('li').find('.list-group').html(html);
		    	}
		    }
