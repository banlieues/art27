...
<?php if(base_url()=='https://crm.homegrade.banlieues.be' || base_url()=='https://crm.homegrade.banlieues.be/'):
    
    $is_affiche_navbar=false;
    ...
    ?>
<?php if($is_affiche_navbar):?>
    <?php $outlook = \Config\Services::outlook(); ?>
<?php endif;?>
                ...
                <?php if(HAS_OUTLOOK):?>
                    <li class="nav-item dropdown mx-2" >
                        ...
                        <i class="<?php echo icon('download'); ?>"></i> <!--Alerts-->
                            <span class="badge bg-danger text-white text-center fw-bold indicator_mail_non_traite"><i class="fa fa-circle-notch fa-spin d-none"></i>
                            <?php if($is_affiche_navbar):?>
                            <?php echo $outlook->refresh_nontraites()?> 
                            <?php else:?>
                    ...
                    <li class="nav-item dropdown  mx-2" >
                        <a role="button"
                            ...
                            <span class="badge bg-danger text-white text-center fw-bold indicator_mail_non_lu"><i class="fa fa-circle-notch fa-spin d-none"></i>
                            <?php if($is_affiche_navbar):?> 
                                <?php echo $outlook->refresh_nonlus(1)?>
                            <?php else:?>
                                <i class="fa fa-circle-notch fa-spin"></i>
                            <?php endif;?>
                            </span>
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="dropdown02">
                            ...
                            <?php if($is_affiche_navbar):?>
                                <?php echo $outlook->refresh_nonlus(0)?>
                                <?php else:?>
                                    <i class="fa fa-circle-notch fa-spin"></i>
                            <?php endif;?>
                            </div>
                    ...
                    <li class="nav-item dropdown  mx-2" >
                         <a role="button"
                            ...
                            <span class="badge bg-danger text-white text-center fw-bold indicator_messagerie_non_lu"><i class="fa fa-circle-notch fa-spin d-none"></i>
                            <?php if($is_affiche_navbar):?>
                            <?=$messagerie->count_non_lu();?>
                            <?php else:?>
                                <i class="fa fa-circle-notch fa-spin"></i>
                            <?php endif;?>
                        </span>
