...
<body>
    <?php if(isset($answer->token) && isset($answer->id_demande) && isset($answer->id_contact_profil)):?>
        <div class="container mb-4">
            <form 
                class="needs-validation" 
                method="POST" 
                action="<?php echo base_url("enquete/external/save/$answer->token/$answer->id_demande/$answer->id_contact_profil/$lang");?>"
                >

                <?php echo $enquete->preview->$lang;?>

                <div class="row justify-content-center">
                    <button type="button" class="btn btn-primary w-auto" 
                        onclick="js_enquete_submit_with_validation(this)"
                        > 
