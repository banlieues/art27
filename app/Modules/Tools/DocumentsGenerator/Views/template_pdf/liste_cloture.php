...
<table class="arial2" cellpadding="2" cellspacing="0" style="width: 100%; border: 0px;">
	...
	<tr>
		...
		<td align="left" width="25%" style="border:1px solid black"><?=$contact->statutsuivi?></td>
		<td align="center" width="3%" style="border:1px solid black"><?=$contact->adherent?></td>
		<td align="left" width="3%" style="border:1px solid black"><?=$contact->alimentation?></td>
		<td align="left" width="3%" style="border:1px solid black"><?=$contact->remarques_inscription?></td>
