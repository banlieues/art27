...
<div class="row">
    <div class="col-md-12">
        <form action="<?php echo base_url('documentstemplates/duplicate'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="card flex-fill border-top-office mb-4">
                ...
                <div class="card-body-off">
                    ...
                    <!--
                    <div class="row">
                        <div class="col-md-12 col-xs-12 col-sm-6 col-lg-12 ms-3 me-3">
                            <?php // echo lang('DocumentsTemplates.areyousure_duplicate'); ?>
                        </div>
                        <div class="float-start ms-3 mt-2 mb-3">
                            <button type="submit" class="btn btn-success btn-sm">
