                    ...
                    <div class="card flex-fill mb-4 card_sortable">
                        ...
                        <div class="card-header border-top-<?php echo $themes->$type_component->color;?>">
                            <h5 class="card-title d-flex justify-content-between align-items-center">
                                <span class="text-<?php echo $themes->$type_component->color;?>"><?php echo $themes->$type_component->icon;?></span>
                                    <?php if($component->title=="##label_categorie_partenaire_social##"):?>
                                            <?= $dataViewConstructorModel->get_label_categorie_partenaire_social($component->categorie_profil_partenaire_social);?>
                                    <?php else:?>
                                        <?=$component->title?>       
                                    <?php endif;?>
                                    ...
                                    <div class="btn-group btn_contextuel_menu_form">
                                        ...
                                        <ul class="dropdown-menu">
                                           ...
                                           <?php if(!empty($component->is_link_externe)||!empty($component->is_multiple)):?>
                                                ...
                                                <?php if(isset($value_transfert[$cc]->id_partenaire_social_profil_gasap)):?>
                                                    <li><hr class="dropdown-divider"></li>
                                                    <li><a text_alert="cette relation" id_delete="<?=$value_transfert[$cc]->id_partenaire_social_profil_gasap?>"  href="<?=base_url()?>/partenaire_social/delete_relation_partenaire_social_profil/" class="ban_deleteForm ban_modification_component dropdown-item"><i class="<?=icon("unlink")?>"></i> Effacer la relation</a></li>
                                                <?php endif;?>
                                        <?php endif;?>
                        ...
                        <div <?php if($component->type=="demande"&&$typeDataView!=="modelisation"&&$count_clone>1):?>style="max-height: 40vh !important; overflow: auto"<?php endif;?> class="card_component card-body <?php if($typeDataView=="modelisation"):?>fields-sortable<?php endif;?>">
                            ...
                            <?php if($typeDataView!="update"&&$typeDataView!="create"):?>
                                <?php if(isset($fields["id_partenaire_social"]["label"])&&$typeDataView=="update"&&$component->rank==1):?>
                                    <div class="row mb-2">
                                        
                                        <div class="col-lg-6"><b><?=$fields["id_partenaire_social"]["label"];?></b></div>
                                        <div class="col"><?=$partenaire_social->id_partenaire_social?></div>
                                    </div>
                                <?php endif;?>
                            ...
                            <?php if($typeDataView=="read"||$typeDataView=="create"):?> 
                                    ...
                                    <div <?php if($typeDataView=="read"):?>style="display:none"<?php endif;?> class="view_components_update container_form_search_link">
                                        ...
                                        <input type="hidden" value="<?=$id_partenaire_social?>" name="id_entity">
                                      
                                         
                                        <input type="hidden" value="<?=$id_partenaire_social?>" name="id_partenaire_social">
                                              
                                        <?php if($component->type=="partenaire_social_caracteristique"):?>
                                            
                                            <?php if(isset($vtcc->id_partenaire_social_caracteristique)):?>
                                                <input type="hidden" value="<?=$vtcc->id_partenaire_social_caracteristique?>" name="id_partenaire_social_caracteristique">
                                            <?php else:?>
                                                <input type="hidden" value="0" name="id_partenaire_social_caracteristique">
                                        ...
                                        if($component->type=="demande"):?>
                                            ...
                                            <?php $possible_id=["id_demande_caracteristique","id_contact","id_demande","id_contact_profil","id_personne_partenaire_social"]; ?>
