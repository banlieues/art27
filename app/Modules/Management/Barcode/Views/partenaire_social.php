...
<div class="row">
    <div class="col-2">
            ...
            <table class="table-bordered table" style="width:100px; position:fixed">
            <?php $num_position=1;?>
            <tr>
            ...
            <tr>
                <?php for($k=0;$k<$nb_col;$k++):?>
                    <td>
                        <form action="<?=base_url()?>partenaire_social/barcode_generator" method="get">
                        ...
                        <input type="hidden" name="a_partir_de" value="<?=$num_position?>">
    ...
    <div class="col-10">
        ...
        <div class="mt-4 mb-2">
            <p class="text-center"><small><b>-- Page <?=$page_encours?>/<?=$total_pages;?> --</b></small></p>
