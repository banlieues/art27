...
<div style="margin-bottom:20px" class='entities c_rubrique'>
    ...
    <div style="margin-bottom:0 !important; margin:10px; border-color: SALMON !important" class="panel panel-info">
    <div style='background-color: SALMON !important; border-color: SALMON !important' class="panel-heading">
	<div class='row'>
	    <div style='font-size:24px; min-height: 40px' class='col-lg-6'>
	    <?php echo icon("stand");?> Stand
