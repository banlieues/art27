<?php
// replace a text variable (placeholder) with a WordFragment in headers, footers and document keeping placeholder styles from an existing DOCX
...
$docx->replaceVariableByWordFragment(array('WORDFRAGMENT_HEADER' => $wf), array('type' => 'block', 'target' => 'header', 'stylesReplacementType' => 'usePlaceholderStyles'));
// replace the text variable in footers
$docx->replaceVariableByWordFragment(array('WORDFRAGMENT_FOOTER' => $wf), array('type' => 'block', 'target' => 'footer', 'stylesReplacementType' => 'usePlaceholderStyles'));
// replace the text variable in the document
$docx->replaceVariableByWordFragment(array('WORDFRAGMENT_BODY' => $wf), array('type' => 'block', 'stylesReplacementType' => 'usePlaceholderStyles'));

$docx->createDocx('example_replaceVariableByWordFragment_8');