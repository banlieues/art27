 ...
 */
class TransformDocAdvPDFPlugin extends TransformDocAdvHTMLPlugin
{
    /**
    ...
    public function __construct() {
        $this->baseCSS = '<style>p { margin-top: 0px;margin-bottom: 0px;}span.tabcontent{margin-left: 50px;}.page_break { page-break-before: always; }</style>';
