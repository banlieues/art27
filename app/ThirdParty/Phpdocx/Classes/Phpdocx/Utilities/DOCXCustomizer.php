...
class DOCXCustomizer extends DOCXPath
{
    ...
    public function customize(\DOMElement $wordElement, $options = array())
    {
        ...
        if ($options['tagType'] == 'paragraph' || $options['tagType'] == 'list' || $options['tagType'] == 'style') {
            ...
            if (isset($options['dstrike'])) {
                if ($options['tagType'] == 'style') {
                    $this->generateWrapperContent($wordElement, 'dstrike', 'rPr', array('w:val' => $options['dstrike']));
                } else {
                    $this->generateWrapperRprContent($wordElement, 'dstrike', 'rPr', array('w:val' => $options['dstrike']));
                }
            }
            ...
            if (isset($options['strike'])) {
                if ($options['tagType'] == 'style') {
                    $this->generateWrapperContent($wordElement, 'strike', 'rPr', array('w:val' => $options['strike']));
                } else {
                    $this->generateWrapperRprContent($wordElement, 'strike', 'rPr', array('w:val' => $options['strike']));
                }
            }
            ...
            if (isset($options['vanish'])) {
                if ($options['tagType'] == 'style') {
                    $this->generateWrapperContent($wordElement, 'vanish', 'rPr', array('w:val' => $options['vanish']));
                } else {
                    $this->generateWrapperRprContent($wordElement, 'vanish', 'rPr', array('w:val' => $options['vanish']));
                }
            }
