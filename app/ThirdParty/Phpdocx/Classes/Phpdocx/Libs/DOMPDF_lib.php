...
class FrameParser_Tree {
  ...
  protected function _build_tree_r(\DomNode $node) {
    if (file_exists(dirname(__FILE__) . '/../Transform/HTMLExtended.php') && \Phpdocx\Transform\HTML2WordML::$htmlExtended) {
...
class PARSERHTML {
    ...
    if (class_exists('tidy')) {
      try {
        ...
        if (file_exists(dirname(__FILE__) . '/../Transform/HTMLExtended.php') && \Phpdocx\Transform\HTML2WordML::$htmlExtended) {
          ...
          $extendedTagsInline = \Phpdocx\Transform\HTMLExtended::getTagsInline();
          $tidyConfiguration['new-inline-tags'] = join(' ', array_keys($extendedTagsInline));
          $extendedTagsBlock = \Phpdocx\Transform\HTMLExtended::getTagsBlock();
  ...
  protected function _process_html($filter = '*') {
    ...
    if (\Phpdocx\Create\CreateDocx::$baseCSSHTML != null && file_exists(dirname(__FILE__) . '/../Transform/HTMLExtended.php')) {
      $this->_css->load_css(\Phpdocx\Create\CreateDocx::$baseCSSHTML);
    }
    ...
    foreach ($styles as $style) {
      ...
      if (\Phpdocx\Transform\HTML2WordML::$cssEntityDecode == true) {
  ...
  private function _render(FrameParser $frame, $filter = false){
    ...
    switch($node->nodeName){
      ...
      default:
        if (file_exists(dirname(__FILE__) . '/../Transform/HTMLExtended.php') && \Phpdocx\Transform\HTML2WordML::$htmlExtended) {
            // support extended tags
            $extendedTagsInline = \Phpdocx\Transform\HTMLExtended::getTagsInline() + \Phpdocx\Transform\HTMLExtended::getTagsBlock();
...
class StyleParser {
  ...
  function __construct(StyleParsersheet $stylesheet) {
    ...
    // CSS Extended
    if (file_exists(dirname(__FILE__) . '/../Transform/HTMLExtended.php') && \Phpdocx\Transform\HTML2WordML::$htmlExtended) {
      $cssExtendedTags = \Phpdocx\Transform\HTMLExtended::getCSSExtendedStyles();
    ...
    if ( !isset(self::$_defaults) ) {
      ...
      // CSS Extended
      if (file_exists(dirname(__FILE__) . '/../Transform/HTMLExtended.php') && \Phpdocx\Transform\HTML2WordML::$htmlExtended) {
        $cssExtendedInheritedTags = \Phpdocx\Transform\HTMLExtended::getCSSExtendedStylesInherited();
