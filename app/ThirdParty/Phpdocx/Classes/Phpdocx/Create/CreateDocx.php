...
use Phpdocx\Crypto;
use Phpdocx\Elements\CreateBibliography;
use Phpdocx\Elements\CreateChartRels;
use Phpdocx\Elements\CreateCitation;
...
use Phpdocx\Elements\CreateSVG;
...
class CreateDocx extends CreateDocument
{
    ...
    {
        if (!file_exists(dirname(__FILE__) . '/../Elements/CreateBibliography.php')) {
            PhpdocxLogger::logger('This method is not available for your license.', 'fatal');
        }
    ...
    {
        if (!file_exists(dirname(__FILE__) . '/../Elements/CreateCitation.php')) {
            PhpdocxLogger::logger('This method is not available for your license.', 'fatal');
        }
    ...
    public function addComment($options = array())
    {
        ...
        if ($options['textComment'] instanceof WordFragment) {
            ...
            if (isset($options['initials'])) {
                $commentBase .= ' w:initials="' . htmlspecialchars($options['initials']) . '"';
            }
            if (isset($options['author'])) {
                $commentBase .= ' w:author="' . htmlspecialchars($options['author']) . '"';
            }
            ...
            $commentBase = preg_replace('/__[A-Z]+__/', '', $commentBase);
            ...
            $commentBase .= '<w:t xml:space="preserve">' . htmlspecialchars($options['textComment']) . '</w:t></w:r></w:p>';
            $commentBase .= '<w:bookmarkStart w:id="' . $idBookmark . '" w:name="_GoBack"/><w:bookmarkEnd w:id="' . $idBookmark . '"/>';
            $commentBase .= '</w:comment>';
        }
    ...
    public function addEndnote($options = array())
    {
        ...
        if ($options['textEndnote'] instanceof WordFragment) {
            ...
            $endnoteBase = preg_replace('/__[A-Z]+__/', '', $endnoteBase);
            ...
            if (isset($options['referenceMark']['font'])) {
                $endnoteBase .= '<w:rFonts w:ascii="' . $options['referenceMark']['font'] .
                        ...
                        '" w:eastAsia="' . $options['referenceMark']['font'] .
            ...
            if (isset($options['endnoteMark']['font']) || 
                ...
                if (isset($options['endnoteMark']['font'])) {
                    $endnoteBase .= '<w:rFonts w:ascii="' . $options['endnoteMark']['font'] .
                            ...
                            '" w:eastAsia="' . $options['endnoteMark']['font'] .
            ...
            $endnoteBase .= '<w:t xml:space="preserve">' . htmlspecialchars($options['textEndnote']) . '</w:t></w:r>';
            if (self::$trackingEnabled == true) {
                $endnoteBase .= '</w:ins>';
    ...
    public function addFootnote($options = array())
    {
        ...
        if ($options['textFootnote'] instanceof WordFragment) {
            ...
            $footnoteBase = preg_replace('/__[A-Z]+__/', '', $footnoteBase);
            ...
            if (isset($options['footnoteMark']['font']) || 
                ...
                if (isset($options['footnoteMark']['font'])) {
                    $footnoteBase .= '<w:rFonts w:ascii="' . $options['footnoteMark']['font'] .
                            ...
                            '" w:eastAsia="' . $options['footnoteMark']['font'] .
            ...
            $footnoteBase .= '<w:t xml:space="preserve">' . htmlspecialchars($options['textFootnote']) . '</w:t></w:r>';
            if (self::$trackingEnabled == true) {
                $footnoteBase .= '</w:ins>';
    ...
    {
        if (!file_exists(dirname(__FILE__) . '/../Elements/CreateSource.php')) {
            PhpdocxLogger::logger('This method is not available for your license.', 'fatal');
        }
        ...
        // check if the source tag name exists
        /*if (!) {
    ...
    public function addSVG($svg, $options = array()) {
        if (!extension_loaded('imagick')) {
            throw new \Exception('Install and enable ImageMagick for PHP (https://www.php.net/manual/en/book.imagick.php) to transform HTML to DOCX.');
        }
    ...
    protected function addImageCaption($isWordFragment, $data)
    {
        ...
        $caption = str_replace('__GENERATESUBR__', (string) $bookmarkEnd, (string) $caption);
